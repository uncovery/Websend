 ...
 *  (Project page: https://github.com/uncovery/Websend)
 */
class Websend {
    ...
    */
    public function connect() {
        ...
        if ($this->stream){
            ...
            error_log("Websend connect() failed: " . var_export($this, true));
            return false;
        }
    }
    ...
    */
    public function doCommandAsConsole($cmmd) {
        ...
        if ($this->readRawInt() == 1) {
            ...
            error_log("Websend doCommandAsConsole failed: " . var_export($this, true));
            return false;
        }
    }
